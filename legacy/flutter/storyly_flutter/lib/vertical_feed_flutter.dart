...
class VerticalFeed extends StatefulWidget {
  ...
  /// This callback function will notify you about updates the cart in a VerticalFeed component
...
class _VerticalFeedState extends State<VerticalFeed> {
  @override
  Widget build(BuildContext context) {
    const viewType = 'FlutterVerticalFeed';
  ...
  void _onPlatformViewCreated(int _id) {
    ...
    widget.onVerticalFeedCreated?.call(
      VerticalFeedController(_id, methodChannel),
    );
  }
